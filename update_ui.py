...
file_path = r'd:\portfolio\index.html'
...
# 5. Fix syntax error
content = content.replace('''        .nav-link:hover::before {
...
if '.text-gradient' not in content:
...
content = content.replace('''        .card-hover:hover {
...
content = content.replace('''        .skill-item {
